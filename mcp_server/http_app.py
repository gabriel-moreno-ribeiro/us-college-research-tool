...
def create_app() -> Starlette:
    ...
    # We wrap using Starlette's middleware stack
    # Since streamable_http_app returns a Starlette, we add routes and middleware
    # by creating a new app that mounts MCP + health
    app = Starlette(
        routes=[
